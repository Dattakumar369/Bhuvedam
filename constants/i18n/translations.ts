...
const en: Translations = {
  ...
  chatImageDefaultPrompt:
    'First check: is this a crop or field photo? If not, say so. If yes, identify visible disease/pest/nutrient issues and give practical steps.',
  chatImageSessionNote: 'Photos stay on your phone only — not saved to server.',
  chatImageScanHint: 'Attach a photo and tap Send — optional text. AI reads the image directly.',
  chatImagePickerTitle: 'Scan farm photo',
  chatImagePickerMessage: 'Use a clear close-up of crop leaf, stem, or pest on the plant. Not for laptops or indoor objects.',
...
const te: Translations = {
  ...
  chatImageDefaultPrompt:
    'Mundu chudandi — idi panta/field photo na? Kadu ante cheppandi. Avunu ante rogam/tegu/poshak samasya em kanipistundo cheppandi.',
  chatImageSessionNote: 'Photos ee chat lo matrame untayi — server ki save avvavu.',
  chatImageScanHint: 'Photo attach chesi Send — text optional. AI photo chusi direct ga cheptundi.',
  chatImagePickerTitle: 'Panta photo scan',
  chatImagePickerMessage: 'Rogam unna crop aku, stem, leda tegu close-up photo — laptop/indoor photos vadhu.',
